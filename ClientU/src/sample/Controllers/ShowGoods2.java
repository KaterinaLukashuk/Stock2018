...
public class ShowGoods2 {
    ...
    @FXML
    private TableView<Footwear> goodsTable;
...
//////////////////////////////////////////////////////
    ...
    void initialize() {
        ...
        ObservableList<Footwear> data = FXCollections.observableArrayList();
        ArrayList<Footwear> mas = null;
        try {
            mas = (ArrayList<Footwear>) Main.client.RecvMess();
        ...
        filtr.setOnAction(event -> {
            ...
            {    if (minPrice.getText().isEmpty() || maxPrice.getText().isEmpty())
                ...
                if (combo.getSelectionModel().getSelectedItem().equals("По цене"))
                    Main.client.setMessage("FiltrGoodsByPr2");
                else  Main.client.setMessage("FiltrGoodsByAm2");
                Main.client.SendMess();
        ...
        filtr1.setOnAction(event -> {
            Main.client.setMessage("ShowAllProd2");
            Main.client.SendMess();
            ObservableList<Footwear> data2 = FXCollections.observableArrayList();
            ArrayList<Footwear> mas2 = null;
            // ArrayList<Product> mas = null;
            try {
                mas2 = (ArrayList<Footwear>) Main.client.RecvMess();
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }
