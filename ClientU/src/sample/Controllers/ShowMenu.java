...
public class ShowMenu {
   ...
   //     assert comboShow != null : "fx:id=\"comboShow\" was not injected: check your FXML file 'ShowMenu.fxml'.";
        ObservableList<String> showlist = FXCollections.observableArrayList("Товары / одежда","Товары / обувь","Товары / аксессуары", "Заказы", "Поставки");
        ...
        ShowInfo.setOnAction(event -> {
            switch (comboShow.getSelectionModel().getSelectedItem())
            {
               ...
               //     Main.client.SendMess();
                ...
                stage.close();
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/ShowGoods.fxml"));
                Parent root1 = null;
                try {
             ...
             //       Main.client.SendMess();
                    ...
                    stage.close();
                    fxmlLoader = new FXMLLoader(getClass().getResource("/ShowGoods2.fxml"));
                    root1 = null;
                    try {
                        root1 = (Parent) fxmlLoader.load();
                    } catch (IOException e) {
                 ...
                 //       Main.client.SendMess();
                        stage = (Stage) ShowInfo.getScene().getWindow();
                        stage.close();
                        fxmlLoader = new FXMLLoader(getClass().getResource("/ShowGoods3.fxml"));
                        root1 = null;
                        try {
                            root1 = (Parent) fxmlLoader.load();
                        } catch (IOException e) {
                ...
                case "Заказы":
                    ...
                    stage = (Stage) ShowInfo.getScene().getWindow();
                    stage.close();
                    fxmlLoader = new FXMLLoader(getClass().getResource("/ShowOrders.fxml"));
                    root1 = null;
                    try {
                        root1 = (Parent) fxmlLoader.load();
                    } catch (IOException e) {
                ...
                case "Поставки":
                    ...
                    stage = (Stage) ShowInfo.getScene().getWindow();
                    stage.close();
                    fxmlLoader = new FXMLLoader(getClass().getResource("/ShowSuppl.fxml"));
                    root1 = null;
                    try {
                        root1 = (Parent) fxmlLoader.load();
                    } catch (IOException e) {
